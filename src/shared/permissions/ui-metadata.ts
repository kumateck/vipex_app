...
const GROUP_DEFAULTS: Record<string, GroupDefault> = {
  ...
  Procurement: { mainTab: 'Operations', module: 'Procurement' },
  'Fleet & Transport': { mainTab: 'Operations', module: 'Fleet & Transport' },
  'Customer Wallet': { mainTab: 'Finance', module: 'Customer Wallet' },
...
const KEY_OVERRIDES: Partial<Record<PermissionKey, Partial<GroupDefault> & { module?: string }>> = {
  ...
  CanReadAccountingAccounts: { mainTab: 'Finance', module: 'Accounting Accounts' },
  CanCreateAccountingAccounts: { mainTab: 'Finance', module: 'Accounting Accounts' },
  CanUpdateAccountingAccounts: { mainTab: 'Finance', module: 'Accounting Accounts' },
  CanDeleteAccountingAccounts: { mainTab: 'Finance', module: 'Accounting Accounts' },
  CanReadAccountingExpenseCategories: { mainTab: 'Finance', module: 'Expense Categories' },
  CanCreateAccountingExpenseCategories: { mainTab: 'Finance', module: 'Expense Categories' },
  CanUpdateAccountingExpenseCategories: { mainTab: 'Finance', module: 'Expense Categories' },
  CanDeleteAccountingExpenseCategories: { mainTab: 'Finance', module: 'Expense Categories' },
  CanReadAccountingApprovalPolicies: { mainTab: 'Finance', module: 'Approval Policies' },
  CanCreateAccountingApprovalPolicies: { mainTab: 'Finance', module: 'Approval Policies' },
  CanUpdateAccountingApprovalPolicies: { mainTab: 'Finance', module: 'Approval Policies' },
  CanDeleteAccountingApprovalPolicies: { mainTab: 'Finance', module: 'Approval Policies' },
  CanReadAccountingBankAccounts: { mainTab: 'Finance', module: 'Bank Accounts' },
  CanCreateAccountingBankAccounts: { mainTab: 'Finance', module: 'Bank Accounts' },
  CanUpdateAccountingBankAccounts: { mainTab: 'Finance', module: 'Bank Accounts' },
  CanDeleteAccountingBankAccounts: { mainTab: 'Finance', module: 'Bank Accounts' },
  CanReadAccountingTaxProfiles: { mainTab: 'Finance', module: 'Tax Profiles' },
  CanCreateAccountingTaxProfiles: { mainTab: 'Finance', module: 'Tax Profiles' },
  CanUpdateAccountingTaxProfiles: { mainTab: 'Finance', module: 'Tax Profiles' },
  CanDeleteAccountingTaxProfiles: { mainTab: 'Finance', module: 'Tax Profiles' },
  CanReadAccountingTaxComponents: { mainTab: 'Finance', module: 'Tax Components' },
  CanCreateAccountingTaxComponents: { mainTab: 'Finance', module: 'Tax Components' },
  CanUpdateAccountingTaxComponents: { mainTab: 'Finance', module: 'Tax Components' },
  CanDeleteAccountingTaxComponents: { mainTab: 'Finance', module: 'Tax Components' },
  ...
  CanReadAccountingManualEntries: { mainTab: 'Finance', module: 'Accounting Entries' },
  CanCreateAccountingManualEntries: { mainTab: 'Finance', module: 'Accounting Entries' },
  CanApproveAccountingManualEntries: { mainTab: 'Finance', module: 'Accounting Entries' },
