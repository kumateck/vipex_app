...
export default function AuditTrailByModulePage() {
  ...
  return (
    <div className="w-full p-4 space-y-4">
      <ScrollableWrapper>
        <Card>
          <CardHeader>
            <CardTitle>Audit Trail by Module</CardTitle>
            <CardDescription>
              Track audit events by module, including action, actor, and affected record.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <AuditReportActions
              filenamePrefix="audit-trail-by-module"
              rows={data?.data ?? []}
              disabled={isLoading}
            />
            ...
            <DataTable
              ...
              searchPlaceholder="Search action, message, or module"
