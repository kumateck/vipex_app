    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Accounting uses this company-level setting. When disabled, accounting pages and routes
            are unavailable and operational parcel/payment flows continue normally.
          </CardDescription>
        </CardHeader>
