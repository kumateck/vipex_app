  ...
  return (
    <div className="w-full space-y-4 p-4">
      ...
      <EmployeesLinkUserDialog
        ...
        onUserRoleIdChange={setUserRoleId}
        onUserBranchIdChange={(value) => {
          setUserBranchId(value);
          setUserLocationId('');
        }}
        onUserLocationIdChange={setUserLocationId}
        isSubmitting={isLinking}
        onOpenChange={(open) => !open && setLinkEmployee(null)}
