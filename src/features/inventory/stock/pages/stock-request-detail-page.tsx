          ...
          <PermissionGuard permissionKey={PermissionKeys.CanRejectStockRequest}>
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <Button
                  variant="destructive"
                  onClick={() => rejectRequest({ reason: rejectionReason })}
              ...
              <table className="min-w-full text-sm border-collapse">
                ...
                <tbody>
                  {(request.lines ?? []).map((line) => {
                    ...
                    const pendingAck = Math.max(
                      0,
                      Number(line.pendingAcknowledgementQuantity ?? 0),
                    );
                    return (
                        ...
                        <td className="py-2 pr-4">
                          {canFulfill && remaining > 0 ? (
                            <div className="flex gap-2">
                              <PermissionGuard
                                permissionKey={PermissionKeys.CanFulfillStockRequest}
                              >
                              ...
                              >
                                <Button
                                  size="sm"
                                  onClick={() => autoFulfillLine(line.id)}
