    ...
    <ScrollableWrapper>
      <div className="w-full space-y-4 p-4">
        ...
        <SelectedDayEventsDialog
          ...
          groupedSelectedDayMeetings={groupedSelectedDayMeetings}
        ...
        <CreateEditEventDialog
          ...
          editingEventMessageId={editingEventMessageId}
          ...
          onEventThreadIdChange={setEventThreadId}
          threads={threads}
          eventLink={eventLink}
          onEventLinkChange={setEventLink}
          userOptions={userOptions}
          eventParticipantUserIds={eventParticipantUserIds}
          onEventParticipantUserIdsChange={setEventParticipantUserIds}
          eventReminderMinutes={eventReminderMinutes}
          onEventReminderMinutesChange={setEventReminderMinutes}
