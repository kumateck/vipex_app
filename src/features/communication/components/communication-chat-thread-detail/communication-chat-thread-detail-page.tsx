    ...
    <div className="w-full p-3">
      <div className="flex h-[calc(100vh-7rem)] flex-col overflow-hidden rounded-2xl border bg-background shadow">
        ...
        <UploadAttachmentDialog
          ...
          onUpload={() => void onUploadPickedFile()}
        />
        ...
        <RecorderDialog
          ...
          recorderPreviewRef={recorderPreviewRef}
          isPreparingRecording={isPreparingRecording}
          onCancel={() => closeRecorderDialog()}
        ...
        <VideoPlayerDialog
          ...
          activeVideoAttachment={activeVideoAttachment}
        />
        ...
        <CreateCallBubbleDialog
          ...
          onCreateCallTypeChange={setCreateCallType}
          onCancel={() => setIsCallDialogOpen(false)}
          onCreate={() => void onCreateCallBubble()}
        ...
        <ScheduleMeetingBubbleDialog
          ...
          onMeetingStartAtChange={setMeetingStartAt}
          meetingReminderMinutes={meetingReminderMinutes}
          onMeetingReminderMinutesChange={setMeetingReminderMinutes}
          onCancel={() => setIsMeetingDialogOpen(false)}
          onCreate={() => void onCreateMeetingBubble()}
        />
      </div>
    </div>
  );
