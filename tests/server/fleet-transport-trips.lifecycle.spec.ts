    ...
    await db.insert(rolePermissions).values([
      {
        companyId,
        roleId,
        permission: PermissionKeys.CanReadFleetTrips,
      },
      {
        companyId,
        roleId,
        permission: PermissionKeys.CanCreateFleetTrips,
      },
      {
        companyId,
        roleId,
        permission: PermissionKeys.CanAssignFleetCrew,
      },
      {
        companyId,
        roleId,
        permission: PermissionKeys.CanStartFleetTrips,
      },
      {
        companyId,
        roleId,
        permission: PermissionKeys.CanCloseFleetTrips,
      },
    ]);
